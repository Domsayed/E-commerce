...
const ProductListScreen = () => {
	...
	const {loading:loadingDelete,error:errorDelete,products:productsDelete,successDelete}=productDelete;
	...
	return (
		<>
			<Flex mb='5' alignItems='center' justifyContent='space-between'>
				<Heading as='h1' fontSize='3xl' mt='5'>
					Product
				</Heading>
				<Button mt='10' onClick={createProductHandler} colorScheme='orange'>
